# FUSHI Combat And Progression

## Sistema base

- Usa a base de Ordem Paranormal.
- Atributos: Forca, Agilidade, Vigor, Intelecto e Presenca.
- O atributo define a quantidade de d20.
- Em teste normal, pega o melhor resultado.
- Pericia soma bonus fixo.
- Pericias escalam em blocos:
  - +5 treinado
  - +10 expert
  - +15 veterano
...
- Depois da progressao basica: mais 5 pericias treinadas (+5), totalizando 10 pericias treinadas.
